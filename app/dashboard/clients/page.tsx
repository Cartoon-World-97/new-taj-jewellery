...
import { FaPlus, FaEdit, FaTrash, FaEye, FaUser, FaKey } from 'react-icons/fa';
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-zinc-400">Manage client accounts and permissions</p>
        </div>
        <button
          onClick={() => {
            resetForm();
          ...
          <div key={employee._id} className="card">
            ...
            <div className="flex items-center space-x-2 pt-4 border-t border-zinc-800">
              ...
              <button
                ...
                className="flex-1 bg-blue-600 hover:bg-blue-700 text-white text-sm py-2 px-4 rounded-lg transition-colors inline-flex items-center justify-center space-x-2"
              >
                <FaEye />
                <span>View</span>
              </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.lose}
                    onChange={(e) =>
                      setFormData({ ...formData, lose: e.target.value })
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea name="location" id="location" value={formData.location} onChange={(e) =>
